...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_motorcycle'])) {
    ...
    if (empty($message)) {
        if ($name && $rental_price_final !== false && $rental_price_final >= 0) {
            if ($motorcycleModel->addMotorcycle($name, $description, $rental_price_final, $image_path, $is_available)) {
                $_SESSION['message'] = '<div class="alert alert-success">Motor berhasil ditambahkan!</div>';
                redirect('index.php');
            } else {
                $message = '<div class="alert alert-danger">Gagal menambahkan motor.</div>';
            }
        } else {
...
<head>
    ...
    <title>Tambah Motor Baru - Admin</title>
...
<body>
    ...
    <div class="container mt-4">
        <h1 class="mb-4">Tambah Motor Baru</h1>
        <?php echo $message; ?>
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="rental_price" name="rental_price" required min="0" inputmode="numeric" pattern="[0-9,\.]*">
            </div>
            <div class="mb-3">
            ...
            <button type="submit" name="add_motorcycle" class="btn btn-primary">Simpan Motor</button>
